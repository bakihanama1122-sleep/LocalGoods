      ...
      <div className='fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center'>
        <div className='bg-gray-800 p-6 rounded-lg md:w-[450px] shadow-lg'>
          ...
          <p className='text-gray-300 mt-4'>
            ...
            <br/>
            This product will be moved to a **delete state** and permanently remove **after 24 hours**. You can recover it within this time.
          </p>
          ...
          <div className='flex justify-end gap-3 mt-6'>
            ...
            } px-4 pt-2 rounded-md text-white font-semibold transition`}
            >
