...
export const createPaymentSession = async(
    ...
    try {
        ...
        // fetch sellers and their atripe accounts
...
export const createOrder = async(
    ...
    try {
        ...
        if(event.type === "payment_intent.succeeded"){
            const paymenetIntent = event.data.object as Stripe.PaymentIntent;
            const sessionId = paymenetIntent.metadata.sessionId;
            const userId = paymenetIntent.metadata.userId;
        ...
        const {cart,total,shippingAddressId,coupon} = JSON.parse(sessionData);
