...
import DeleteConfirmationModal from "apps/admin-ui/src/shared/components/modals/delete.confirmation.modal";

const fetchProducts = async () => {
  const res = await axiosInstance.get("/admin/api/get-all-products",{withCredentials:true});
